      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-2 xl:gap-8">
          <div className="space-y-2 xl:grid-cols-1 items-center flex flex-wrap gap-4 md:grid md:grid-cols-2 xl:items-start md:items-center ">
            ...
            <span className="text-gray-500 text-base inline-block pl-8 xl:pr-32 xl:pl-2">
              Um livro que se abre para novas oportunidades.
            </span>
          </div>
          <dl className="mt-8 text-base text-gray-500 grid grid-flow-row-dense ml-5">
                  <div>
            ...
            {navigation.social.map((item) => (
              <Link key={item.name} href={item.href} passHref>
                <a className="text-gray-400 hover:text-gray-500">
                  <span className="sr-only">{item.name['pt-BR']}</span>
